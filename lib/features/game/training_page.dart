        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  ...
                  colors: [AppTheme.primaryYellow, Color(0xFFFFD54F)],
                ),
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Upload your notes and let our AI create perfect quizzes for you!",
                    style: const TextStyle(
                      fontFamily: 'Baloo2',
                      fontSize: 15,
                      color: Color(0xFF4E342E),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const UploadQuizPage(),
                          ),
                        );
                      },
            ...
            GridView.count(
              ...
              children: [
                _FolderCard(color: Colors.yellow[300]!, title: "OOP"),
                _FolderCard(color: Colors.green[300]!, title: "Java"),
                _FolderCard(color: Colors.purple[300]!, title: "Discrete Math"),
                _FolderCard(color: Colors.pink[300]!, title: "Database"),
                _FolderCard(color: Colors.blue[300]!, title: "Web App"),
                _FolderCard(color: Colors.orange[300]!, title: "Mobile App"),
              ],
            ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TrainingFolderPage(title: title),
          ),
        );
      },
      child: Container(
